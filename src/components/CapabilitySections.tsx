...
const capabilities: CapabilitySection[] = [
  {
    ...
    description: 'Convex achieves consensus in milliseconds with zero block delay using Convergent Proof of Stake—a revolutionary CRDT-based algorithm that eliminates the traditional blockchain bottleneck.',
  ...
  },
  {
    ...
    description: 'Lattice Technology provides every project its own global data fabric. No shards, no rollups, no complexity—just infinite horizontal scalability with true global state.',
  ...
  },
  {
    ...
    subtitle: 'One Million TPS',
    description: "The world's fastest decentralised virtual machine. Execute millions of transactions per second on shared global state with sub-second finality.",
  ...
  },
  {
    ...
    subtitle: 'One-Line DeFi',
    description: 'Securely execute complex economic transactions in a single line of Convex Lisp. Build autonomous smart contracts with the power of functional programming.',
    cta: { label: 'Start Building', href: 'https://docs.convex.world', external: true },
    secondaryCta: { label: 'View on GitHub', href: 'https://github.com/Convex-Dev', external: true },
  },
  {
    id: 'agentic',
    number: '05',
    ...
    titleSuffix: 'Future',
    subtitle: 'AI-Native Infrastructure',
    description: 'Designed for the next generation of autonomous economic agents. Native MCP integration enables AI systems to transact, coordinate, and build value autonomously.',
    cta: { label: 'Agentic Architecture', href: 'https://docs.convex.world/docs/overview/agentic-architecture', external: true },
  },
  {
    id: 'mission',
    number: '06',
    ...
    description: 'Governed on a non-profit basis for the good of humanity. Open-source, transparent, and built to serve the collective intelligence of our species.',
    cta: { label: 'Our Foundation', href: 'https://docs.convex.world/docs/overview/governance', external: true },
